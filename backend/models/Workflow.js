...
class Workflow extends Model {
  static associate(models) {
    ...
    this.hasMany(models.WorkflowInstancia, {
  ...
  async criarInstancia(dadosIniciais = {}, usuarioIniciador) {
  ...
  validarTransicao(estadoAtual, proximoEstado, usuario, dadosContexto = {}) {
  ...
  avaliarCondicoes(condicoes, dadosContexto, usuario) {
  ...
  avaliarCondicaoIndividual(condicao, dadosContexto, usuario) {
  ...
  verificarPermissoes(usuario, permissoesNecessarias) {
    // Implementar verificação de permissões
    // Integrar com sistema de permissões existente
    return true; // Simplificado por enquanto
  }

  obterProximosEstados(estadoAtual, usuario, dadosContexto = {}) {
  ...
  async duplicar(novoNome, novoUserId) {
  ...
  // Métodos estáticos
  static async getWorkflowsPorTipo(tipo) {
  ...
  static async buscarPorTrigger(eventoTrigger, dadosEvento = {}) {
  ...
  avaliarCondicoesTrigger(dadosEvento) {
  ...
  static async criarTemplatesPadrao() {
    const templates = [
      {
